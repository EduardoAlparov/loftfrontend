...
new Vue({
  ...
  methods: {
    validateName() {
      this.name = this.$el.querySelector(".forms__block-input--name").value;
    ...
    validateEmail() {
      var regex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
      this.email = this.$el.querySelector(".forms__block-input--mail").value;
    ...
    validateMessage() {
      this.message = this.$el.querySelector(".forms__block-input--text").value;
